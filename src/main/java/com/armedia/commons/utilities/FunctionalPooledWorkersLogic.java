...
public final class FunctionalPooledWorkersLogic<STATE, ITEM, EX extends Throwable>
	...
	public FunctionalPooledWorkersLogic(Function<PooledWorkers<STATE, ITEM>, STATE> initializer,
	...
	public FunctionalPooledWorkersLogic(Function<PooledWorkers<STATE, ITEM>, STATE> initializer,
		BiConsumer<STATE, ITEM> processor, Consumer<STATE> cleanup) {
	...
	public FunctionalPooledWorkersLogic(Function<PooledWorkers<STATE, ITEM>, STATE> initializer,
		BiConsumer<STATE, ITEM> processor, TriConsumer<STATE, ITEM, EX> failureHandler) {
	...
	public FunctionalPooledWorkersLogic(Function<PooledWorkers<STATE, ITEM>, STATE> initializer,
		BiConsumer<STATE, ITEM> processor, TriConsumer<STATE, ITEM, EX> failureHandler, Consumer<STATE> cleanup) {
	...
	public FunctionalPooledWorkersLogic(CheckedFunction<PooledWorkers<STATE, ITEM>, STATE, EX> initializer,
	...
	private STATE nullInitialize(PooledWorkers<STATE, ITEM> worker) throws EX {
		// Do nothing
		return null;
	}
	...
	@Override
	public STATE initialize(PooledWorkers<STATE, ITEM> workers) throws EX {
		return this.initializer.applyChecked(workers);
	}
